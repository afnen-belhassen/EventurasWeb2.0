 ...
 */
final class Version20250430110311 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE commande RENAME INDEX fk_produit TO IDX_6EEAA67DF347EFB
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE commande RENAME INDEX idx_6eeaa67df347efb TO fk_produit
        SQL);
        $this->addSql(<<<'SQL'
